...
class BehavioralGreenhouseAgent:
    ...
    def __init__(self, sim):
        ...
        self.behaviors = [gb.Light(),gb.RaiseTemp(),gb.LowerTemp(),gb.LowerHumid(),gb.RaiseSMoist(),gb.LowerSMoist(),ping.Ping()]
...
class LayeredGreenhouseAgent:
    ...
    def __init__(self,sim,schedulefile):
        ...
        self.execut = layers.ExecutiveLayer()
        
        self.planning = layers.PlanningLayer(schedulefile)
        self.planning.setExecutive(self.execut)
